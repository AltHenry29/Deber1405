...
public class participantes {
    ...
    // Constructor con nombre, edad y teléfono:
    ...
    public participantes(String nombre, String apellido, int edad, String telefono, String correo, String nacionalidad,
                         boolean certificadoMedico, boolean aceptoTerminos) {
        this.nombre = nombre;
        this.apellido = apellido;
        this.edad = edad;
        this.telefono = telefono;
